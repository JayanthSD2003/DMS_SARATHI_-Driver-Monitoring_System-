...
face_cascade = cv.CascadeClassifier("haarcascades/haarcascade_frontalface_default.xml") #add the haarcascade_frontalface_default.xml file
eye_cascade = cv.CascadeClassifier("haarcascades/haarcascade_eye.xml") #add the haarcascade_eye.xml file
...
img = cv.imread('images/test.jpeg') #add the test.jpeg file
